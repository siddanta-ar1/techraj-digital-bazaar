...
export function CategoryMarqueeClient({ categories }: { categories: CategoryItem[] }) {
            ...
            >
              {marqueeList.map((category, index) => (
               ...
               <div 
                ...
                >
                  <div className={`p-1.5 rounded-full ${category.color} group-hover:scale-110 transition-transform`}>
                    {category.icon}
                  </div>
