      ...
      <div className="border-b border-slate-200 bg-white">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between mb-3">
            <button onClick={() => setIsMenuOpen(true)} className="p-1 text-slate-600">
        ...
        <div className="fixed inset-0 z-[100] flex">
          ...
          <div className="relative bg-white w-[80%] max-w-sm h-full shadow-xl flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-4">
               <Link href="/" className="py-2 text-slate-700 font-medium border-b border-slate-100">Home</Link>
               <Link href="/products" className="py-2 text-slate-700 font-medium border-b border-slate-100">All Products</Link>
               <Link href="/login" className="py-3 mt-4 bg-indigo-600 text-white text-center rounded-lg font-bold">Sign In</Link>
            </div>
          </div>
        </div>
      )}
