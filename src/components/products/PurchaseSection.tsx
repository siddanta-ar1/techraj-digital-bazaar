    ...
    <div className="p-8 border border-slate-200 rounded-2xl bg-white shadow-xl shadow-slate-200/50 sticky top-24">
      ...
      <div className="space-y-3">
        <button
          ...
          disabled={isBuying}
          className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-indigo-200 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2"
        >
          {isBuying ? (
            <>
