              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors uppercase ${
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="100"
                    className={`w-full px-4 py-3 border rounded-xl bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors ${
                      errors.usage_limit ? "border-red-300" : "border-slate-300"
                    }`}
                ...
                <div>
                  ...
                  <input
                    type="datetime-local"
                    className={`w-full px-4 py-3 border rounded-xl bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors ${
                      errors.expires_at ? "border-red-300" : "border-slate-300"
                    }`}
